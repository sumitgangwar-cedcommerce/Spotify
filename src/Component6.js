        ...
        return (
            <div id='Component6'>
                <div id='upper'>
                    ...
                    <div>
                        <p className='head_f'>COMPANY</p>
                        <p>About Us</p>
                        <p>Jobs</p>
                        <p>For the Record</p>
                    </div>
                    <div>
                        <p className='head_f'>COMMUNITIES</p>
                        <p>For Artist</p>
                        <p>Developers</p>
                        <p>Advertising</p>
                        <p>Investors</p>
                ...
                <div id='lower'>
                    ...
                    <a href='#'>Cookies</a>
                    <a href='#'>About ads</a>
                    <div>© India(English)<br />©2022 Spotify AB</div>
                </div>
            </div>
          )
    }
